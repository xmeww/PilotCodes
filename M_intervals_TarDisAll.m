...
function [tarIntvs_cyclewise,tarIntvs_trialwise,fIntvs_trialwise,fIntvs_cyclewise,fflipIntv,disIntvs_trialwise] = M_intervals_TarDisAll(ntrials,ncycle,nIntv)
