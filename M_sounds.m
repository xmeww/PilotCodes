function [FGsounds,BGsounds] = M_sounds(nintv_tr,n_c_max,ramp_t,FfgL,FfgH,Fbg,nfig,coh_levels,ntrials,nFigChord,figOnly,preCyc_int)
...
%% bg sound 
BGsounds = nan(2,(preCyc_int+nintv_tr)*length(t),ntrials);
