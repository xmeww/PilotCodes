function [ntrials,nblocks,Vpresent,Apresent,Coh,nItems,condTable,tarOris,tarLocs,nItemsChg] = M_cond_Vselect1_Amulti01(blockRep,condRep,trOrd,nItem_levels,coh_levels,nIntv,ncycle,nitemChg_type)
rng('shuffle');
%% function check
% blockRep = 2;
...
% for b = 1:nblocks 
%     [nItems(:,b),Coh(:,b)] = BalanceFactors(condRep,trOrd,nItem_levels,coh_levels);    
% end
% 
% 
...
nblocks = blockRep;
for b = 1:nblocks
    [nItems(:,b),Apresent(:,b),Coh(:,b),tarOris(:,b)] = BalanceFactors(condRep,trOrd,nItem_levels,Apres_type,coh_levels,tarOri_type);
